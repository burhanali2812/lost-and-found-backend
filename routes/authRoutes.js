...
router.post("/upload", upload.single("image"), authMiddleWare, async (req, res) => {
  try {
    ...
    const uploadResult = await uploadToCloudinary(req.file.buffer, 'lost-and-found/uploads');
...
router.post("/add-foundItems", upload.array("images"), authMiddleWare, async (req, res) => {
  const { userId, title, category, subCategory, brand, description, city, location, dateFound } = req.body;
...
router.post("/add-lostItems", upload.array("images"), authMiddleWare, async (req, res) => {
  const { userId, title, category, subCategory, brand, description, city, location, dateLost } = req.body;
